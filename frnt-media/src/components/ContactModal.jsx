...
export default function ContactModal({ open, onClose }) {
  ...
  useEffect(() => {
    ...
    // ✅ Only this component handles body overflow (Navbar lock removed from Navbar)
  ...
  const inp = {
    ...
    fontSize:'.88rem',color:'var(--white)',
  ...
  return (
    <>
      ...
      <div style={{
        ...
        zIndex:9001,
        display:'flex',
        alignItems:'flex-start', // ✅ flex-start so modal scrolls on small screens
        justifyContent:'center',
        padding:'20px 16px',
        paddingBottom:'env(safe-area-inset-bottom, 20px)', // ✅ notch phones
        pointerEvents:open?'all':'none',
        overflowY:'auto',
        ...
        <div style={{
          ...
          <div className="modal-inner" style={{padding:'28px 32px 32px'}}>
            ...
            <button onClick={onClose} style={{
              ...
              padding:'4px 8px' // ✅ bigger tap target
            }}
            ...
            <div style={{display:'flex',gap:8,marginBottom:24,flexWrap:'wrap'}}>
              {[
                {href:'tel:+919244012840',label:'WhatsApp',val:'+91 92440 12840',c:'var(--c)'},
                {href:'mailto:hello@frntmedia.in',label:'Email',val:'hello@frntmedia.in',c:'var(--p)'}
              ].map(o=>(
            ...
            <form onSubmit={submit}>
              ...
              <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',gap:12,flexWrap:'wrap'}}>
                ...
                <button type="submit" disabled={status!=='idle'} style={{
                  ...
                  fontFamily:'Space Grotesk',fontSize:'.75rem',
      ...
      <style>{`
        @media(max-width:560px){
          ...
          .modal-inner{padding:24px 20px 28px !important}
        }
        @media(max-width:360px){
          .modal-inner{padding:20px 14px 24px !important}
        }
      `}</style>
    </>
  )
